// build.zig — Android native build for phoenix_adopt_mob_demo.
//
...
//     Output: libphoenix_adopt_mob_demo.so installed to
//     android/app/src/main/jniLibs/<abi>/libphoenix_adopt_mob_demo.so so
...
//       -Dapp_name=phoenix_adopt_mob_demo \
//       -Dproject_root=$(pwd)
//
// Steps:
